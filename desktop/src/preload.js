...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  removeStudioJob: (payload) => ipcRenderer.invoke('remove-studio-job', payload),
  clearSubmittedStudioJobs: (payload) => ipcRenderer.invoke('clear-submitted-studio-jobs', payload),
